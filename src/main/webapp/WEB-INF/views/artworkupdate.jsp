...
<section id="infosection">
    <form action="artUpdate" method="POST" enctype="multipart/form-data" name="WForm" autocomplete="off">
        <div id="albumAndFile">
        ...
        <div id="artinfo">
            ...
            <div id="artinfo1" style="position: relative;">
                ...
                <select id="aw-select2" name="a_genre"
                        style="width: 90%; border: none; border: 1px solid black" required>
                    <option value="KPOP" ${aDto.a_genre == 'KPOP' ? 'selected="selected"' : ''}>KPOP</option>
                    <option value="Ballad" ${aDto.a_genre == 'Ballad' ? 'selected="selected"' : ''}>발라드</option>
                    <option value="Indie" ${aDto.a_genre == 'Indie' ? 'selected="selected"' : ''}>인디</option>
                    <option value="Rap/Hip-hop" ${aDto.a_genre == 'Rap/Hip-hop' ? 'selected="selected"' : ''}>랩·힙합
                    </option>
        ...
        <div id="albumdetail">
            ...
            <div style="position: relative; left: 5%; height: 50%">
                <select id="aw-SorG" style="width: 90%; border: 1px solid black" name="a_group">
                    <option value="single" ${aDto.a_group == 'single' ? 'selected="selected"' : ''}>싱글</option>
                    <option value="group" ${aDto.a_group == 'group' ? 'selected="selected"' : ''}>그룹</option>
                </select>
